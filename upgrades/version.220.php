...
class TawkToUpgradeVersion220 extends TawkToUpgradeBase {
    const VERSION = '2.2.0';
    ...
    public static function upgrade($model_setting, $model_store) {
        ...
        foreach ($store_ids as $store_id) {
            ...
            $visibility = json_decode($store_settings['module_tawkto_visibility'], true);
            ...
            $store_settings['module_tawkto_visibility'] = json_encode($visibility);

            $model_setting->editSetting('module_tawkto', $store_settings, $store_id);
        }
    }
